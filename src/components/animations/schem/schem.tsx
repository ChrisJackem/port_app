...
const SchemSvg = ({ frame }: { frame: number }) => {
    function normActivate( cond:boolean ){ return `${styles.frame_el} ${cond ? styles.active : ''}`; }
    
    return (    
        <svg className={styles.svg_image} viewBox="0 0 700 700">
        <g>
            <rect width="700" height="700" fill="#e6e6e6"/>
            ...
            <g id="n" data-name="page" className={`${normActivate( frame >= 2 )}`}>
            ...
            <g id="o" data-name="content" className={`${normActivate( frame >= 4 )}`}>
            ...
            <polygon data-name="CtoR" className={`${normActivate( frame === 1 )}`}                  points="327.34 354.25 463.22 490.13 467.46 485.88 450.48 443.42 446.23 439.17 433.49 451.91 331.58 350 327.34 354.25"/>
            <polygon data-name="RtoC" className={`${normActivate( frame === 2 || frame === 4 )}`}   points="459.13 494.22 323.25 358.34 319 362.58 335.99 405.04 340.23 409.29 352.97 396.55 454.88 498.46 459.13 494.22"/>
            <polygon data-name="LtoR" className={`${normActivate( frame === 3 )}`}                  points="257.83 531.52 450 531.52 450 525.52 407.96 507.5 401.96 507.5 401.96 525.52 257.83 525.52 257.83 531.52"/>
            <polygon data-name="RtoL" className={`${normActivate( frame === 2 )}`}                  points="450 537.3 257.83 537.3 257.83 543.31 299.87 561.32 305.88 561.32 305.88 543.31 450 543.31 450 537.3"/>
        </g>
        </svg>
    )
}
