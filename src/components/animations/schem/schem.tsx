...
const Schem = () => {
    ...
    <div ref={containerRef}>
        ...
        <div className={`flex`}>
            <button onClick={killTimer}>Stop</button>
            <button onClick={startTimer}>Start</button>
            <button onClick={untick}>Prev</button>
...
const SchemSvg = ({ frame }: { frame: number }) => {
    ...
    return (    
    <svg id="b" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="500" height="500" viewBox="0 0 700 600">
        ...
        <g id="h" data-name="page" className={`${normActivate( frame >= 2 )}`}>
        ...
        <g id="i" data-name="content" className={`${normActivate( frame >= 4 )}`}>
        ...
        <g id="j" data-name="CtoR" className={`${normActivate( frame === 1 )}`}>
        ...
        <g id="k" data-name="RtoC" className={`${normActivate( frame === 2 || frame === 4 )}`}>
        ...
        <g id="l" data-name="LtoR" className={`${normActivate( frame === 3 )}`}>
        ...
        <g id="m" data-name="RtoL" className={`${normActivate( frame === 2 )}`}>
