...
export const KidSvg = ()=>{
  return (    
    <svg xmlns="http://www.w3.org/2000/svg" width="300" height="400" viewBox="0 0 400 400" className={styles.svg} overflow="hidden">
      <defs>
      ...
      <g id="d" data-name="kid" clipPath="url(#clip)">
